...
const sendEmail = async (options:SendEmailOptions) => {
  ...
  const mailGenerator = new Mailgen({
    theme: "default",
    product: {
      name: "BookBazaar Manager",
      link: "https://bookbazaarmanager.app",
    },
  });
  ...
  const mail = {
    from: "mail.bookbazaarmanager@example.com", // We can name this anything. The mail will go to your Mailtrap inbox
